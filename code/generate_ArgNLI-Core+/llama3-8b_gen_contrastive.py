...
# data_path = "/home/henrike/ARG-NLI_project/gen_contrastive_samples/corpus_nli_preds_threshold_hard_0.999.tsv"
# data = pd.read_csv(data_path, sep="\t")

# data_sample = data.sample(n=10, random_state=42)

# # seg2 = antecedent
# seg2 = data_sample["seg2_text"]
...
For example:  "The sky is blue." -> "Therefore, we are not expecting any rain.";  
Don't add prefixes or explanations to the output."""

# Prompt3
low_high_system_prompt = """Generate a statement that trivially follows from the given statement and is easy to infer from this statement. 
Use as many words as possible from the given statement to generate your statement. 
For example:  'John likes to eat bananas.' -> 'Therefore, John likes to eat bananas for breakfast every morning.';  
Don't add prefixes or explanations to the output."""


high_high_system_prompt = """Generate a statement that is hard to infer from the given statement. 
Use as many words as possible from the given statement to generate your statement.
You can also swap the subject and the object to achieve this.
For example: 'John likes to eat bananas.' -> 'Therefore, bananas like to eat.' or
'John likes to eat bananas.' -> 'Therefore, bananas like to eat John.'
Don't add prefixes or explanations to the output."""
...
def main():
    parser = argparse.ArgumentParser(description="Generate inferrable consequents in chunks with resume and preview options.")
    ...
    parser.add_argument("--output", "-o", default="/home/henrike/ARG-NLI_project/gen_contrastive_samples/generated_samples/llama3-70b_contrastive_with_sims_inf.tsv")
