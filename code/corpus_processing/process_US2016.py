...
corpus_path = "/home/oenni/Dokumente/ArgumentationCorpora/US2016" #/nodeset9675.json" #/nodeset28362.json" #/nodeset17918.json"
    ...
    if filename.endswith(".json"):
        ...
        for pair in node_pairs:
            if int(i) < 10:
                ...
                i = f"0{i}"
            node_pairs_text.append({"ID":f"US2016_{filename.split(".")[0]}_{i}",
        ...
        df_full.to_csv(f"/home/oenni/Dokumente/NLI-Argumentation-project/corpus/US2016_parsed/full/US2016_{filename.split(".")[0]}_full_parsed.tsv", sep="\t", index=False)
        df_text.to_csv(f"/home/oenni/Dokumente/NLI-Argumentation-project/corpus/US2016_parsed/text/US2016_{filename.split(".")[0]}_parsed.tsv", sep="\t", index=False)