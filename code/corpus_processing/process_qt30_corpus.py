...
corpus_path = "/home/oenni/Dokumente/ArgumentationCorpora/qt30_2" #/nodeset17918.json"
    ...
    if filename.endswith(".json"):
        ...
        for pair in node_pairs:
            if int(i) < 10:
                ...
                i = f"0{i}"
            node_pairs_text.append({"ID":f"QT30_{filename.split(".")[0]}_{i}",
        ...
        df_full.to_csv(f"/home/oenni/Dokumente/NLI-Argumentation-project/corpus/QT30_parsed/full/QT30_{filename.split(".")[0]}_full_parsed.tsv", sep="\t", index=False)
        df_text.to_csv(f"/home/oenni/Dokumente/NLI-Argumentation-project/corpus/QT30_parsed/text/QT30_{filename.split(".")[0]}_parsed.tsv", sep="\t", index=False)