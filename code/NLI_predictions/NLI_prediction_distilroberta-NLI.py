...
# ========== CONFIG ==========
MODEL_NAME = "AdamCodd/distilroberta-NLI"
model_name = MODEL_NAME.split("/")[-1]
INPUT_FILE = "/home/oenni/Dokumente/NLI-Argumentation-project/annotation/nli_gold_df.tsv"
OUTPUT_FILE = f'/home/oenni/Dokumente/NLI-Argumentation-project/annotation/NLI_machine-labeled/noUnrelated/precision_tuned/all_noUnrelated_{model_name}_ft.tsv'
OUTPUT_FILE2 = f'/home/oenni/Dokumente/NLI-Argumentation-project/annotation/NLI_machine-labeled/noUnrelated_decoderOnly/precision_tuned/all_noUnrelated_{model_name}_ft.tsv'
MODEL_OUTPUT_DIR = f'/home/oenni/Dokumente/NLI-Argumentation-project/annotation/NLI_machine-labeled/NLI_Models/precision_tuned/{model_name}_ft'
BATCH_SIZE = 32
SAVE_EVERY = 50
...
n_total = len(df)
n_train = int(0.05 * n_total)  # 5% for training (~56)
n_val = int(0.05 * n_total)    # 5% for validation (~56)
