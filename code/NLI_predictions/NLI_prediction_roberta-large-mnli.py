...
MODEL_OUTPUT_DIR = f'/media/oenni/OenniDrive/Dokumente/NLI-Argumentation-project/NLI_models/f1_tuned/{model_name}_ft'
BATCH_SIZE = 32
SAVE_EVERY = 50
...
n_total = len(df)
n_train = int(0.1 * n_total)  # 5% for training (~56)
