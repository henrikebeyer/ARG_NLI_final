...
OUTPUT_FILE = '/home/oenni/Dokumente/NLI-Argumentation-project/NLI_labeling/full_corpus_gemma3-4b_predictions.tsv'     # Save intermediate & final results here
...
def classify_large_dataset():
    ...
    if 'nli_label_gemma3-4b' not in df.columns:
        df['nli_label_gemma3-4b'] = None

    # Resume support: Skip already labeled
    labeled_mask = df['nli_label_gemma3-4b'].notnull()
    total = len(df)
